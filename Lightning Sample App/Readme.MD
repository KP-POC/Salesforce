...
* [Database Methods](#database-methods)
  * [`insert` method with the allOrNone set to `false`](#insert-method-with-the-allOrNone-set-to-false)
  * [Insert records with partial success](#insert-records-with-partial-success)
